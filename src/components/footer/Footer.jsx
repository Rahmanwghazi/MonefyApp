...
const Footer = () => {
    return(
        <div className="footer container-xxl mx-auto position-relative p-0" style={{fontFamily: "'Poppins', sans-serif"}}>
			...
			<div className="border-color info-footer">
				...
				<div className="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
					<div className="d-flex title-font font-medium align-items-center gap-4">
						<a href="/#">
							<svg className="social-media-c social-media-left" width="30" height="30" viewBox="0 0 30 30"
						...
						<a href="/#">
							<svg className="social-media-c" width="30" height="30" viewBox="0 0 30 30" fill="none"
						...
						<a href="/#">
							<svg className="social-media-p" width="30" height="30" viewBox="0 0 30 30" fill="none"
								xmlns="http://www.w3.org/2000/svg">
								<path
					...
					<nav className="d-flex flex-lg-row flex-column align-items-center justify-content-center">
						<p style={{margin: 0}}>Copyright © 2021 Monefy</p>
					</nav>
				</div>
			</div>
		</div>
